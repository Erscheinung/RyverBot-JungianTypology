...
module.exports = function (robot) {
  ...
  return robot[resType](trigger, function (msg) {
    if (!process.env.AIzaSyAFx4Q27e9brdTaVLV2mroaOsQcEpVwXVQ) {
    ...
    const maxResults = process.env.false === 'true' ? 1 : 15
    ...
    .query({
      ...
      maxResults,
      q: query,
      key: process.env.AIzaSyAFx4Q27e9brdTaVLV2mroaOsQcEpVwXVQ
    })
